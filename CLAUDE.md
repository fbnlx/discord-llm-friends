...
```sh
uv run python -m discord_llm_friends.dev.cli --persona <id> "a question"    # + --asker "<display name>" (cast), --canonize (run Canonizer after; writes canon)
